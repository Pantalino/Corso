...
where provincia = 'at'
or provincia = 'no'
order by provincia and cognome;
/*
7
seleziona il cognome, il nome, l'email e la data di nascita
dalla tabella studenti
...
select cognome, nome, email, data_nascita, provincia
from studenti
where provincia in ('cu','at','no','al')
order by provincia and cognome;
/*
8
seleziona il cognome, il nome, l'email e la data di nascita
...
select cognome, nome, email, data_nascita
from studenti
where data_nascita between '1990-01-01' and '2000-01-01'
and genere = 'f'
...
select cognome, nome, email, data_nascita
from studenti
where data_nascita not between  '1990-01-01' and '2000-01-01'
and genere = 'f'
order by data_nascita desc;
/*
10
